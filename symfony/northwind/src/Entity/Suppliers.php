...
class Suppliers
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Products::class, mappedBy="SupplierID",  orphanRemoval=true, fetch="EAGER")
     */
    private $products;
    ...
    public function removeProducts(Products $products): self
    {
        if ($this->products->removeElement($products)) {
            ...
            if ($products->getSupplierID() === $this) {
                $products->setSupplierID(null);
            }
        }
